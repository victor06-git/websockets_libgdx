...
import com.vasensio.websockets.Main;
import com.vasensio.websockets.WsBridge;
import com.vasensio.websockets.lwjgl3.DesktopWsPositionSender;
...
public class Lwjgl3Launcher {
    ...
    private static Lwjgl3Application createApplication() {
        WsBridge.setSender(new DesktopWsPositionSender("ws://localhost:8888", "player"));
        return new Lwjgl3Application(new Main(), getDefaultConfiguration());
    }

    private static Lwjgl3ApplicationConfiguration getDefaultConfiguration() {
        Lwjgl3ApplicationConfiguration configuration = new Lwjgl3ApplicationConfiguration();
        configuration.setTitle("2DBasicAnimation");
